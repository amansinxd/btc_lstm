...
y_2023 = maindf.loc[(maindf['Date'] >= '2023-06-14')
...
fig.update_layout(title_text='Whole period of timeframe of Bitcoin close price 2023', plot_bgcolor='white', 
...
#plotting los vs  validating loss graph
